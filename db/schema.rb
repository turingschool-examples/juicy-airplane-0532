...
ActiveRecord::Schema.define(version: 2023_01_17_184226) do
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "employee_ticket_id"
    t.iartmentndex ["dep_id"], name: "index_employees_on_department_id"
    t.index ["employee_ticket_id"], name: "index_employees_on_employee_ticket_id"
  end
  ...
  add_foreign_key "employees", "employee_tickets"
